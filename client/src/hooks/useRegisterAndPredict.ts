...
export interface RegisterFormData {
    ...
    pulling_frequency?: string;        // FIXED NAME
    pulling_awareness?: string;        // FIXED NAME

    successfully_stopped?: string;     // FIXED NAME
    how_long_stopped_days?: string;    // FIXED NAME
...
// Human → numeric mapping (ML expects numbers)
