...
# Base dir can be overridden by env var TRICHMIND_BASE_DIR
...
FEATURES_JSON      = PREPROC_META_DIR / "features.json"  # ← your actual path
...
# ── Files / subdirs (TRAINING)
MODEL_DIR          = TRAIN_DIR / "best_models"
MODEL_PATH         = MODEL_DIR / "best_relapse_risk_predictor_model.pkl"
ENCODER_DIR        = TRAIN_DIR / "label_encoder"
LABEL_ENCODER      = ENCODER_DIR / "label_encoder.pkl"
