...
export const errorHandler = (
    ...
    console.error(chalk.cyan(`📍 Route: ${req.method} ${req.originalUrl}`));
    console.error(chalk.magentaBright("🧩 Error Type:"), code);
    console.error(chalk.yellow("📢 Message:"), message);
    if (Object.keys(req.body || {}).length > 0) {
        console.error(chalk.gray("📦 Payload:"), JSON.stringify(req.body, null, 2));
    }
